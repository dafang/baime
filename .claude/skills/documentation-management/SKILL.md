...
description: Systematic documentation methodology for AI-assisted software projects using empirically validated templates, patterns, and automation. Provides structure for living documentation, doc health checks, gap analysis, and doc evolution workflows.
allowed-tools: Read, Write, Edit, Grep, Glob, Bash
---

# Documentation Management Skill

Systematic documentation methodology for AI-assisted software projects using empirically validated templates, patterns, and automation.
...
BAIME_SKILL_SOURCE=.claude/skills/documentation-management
cp "$BAIME_SKILL_SOURCE/templates/tutorial-structure.md" docs/tutorials/my-guide.md
...
```bash
# Validate all links
python "$BAIME_SKILL_SOURCE/tools/validate-links.py" docs/

# Validate command syntax
python "$BAIME_SKILL_SOURCE/tools/validate-commands.py" docs/
```
...
**External Resources**:
- [Claude Code Documentation](https://docs.claude.com/en/docs/claude-code/overview) (Claude-specific host reference)
